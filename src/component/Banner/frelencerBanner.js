                        ...
                        <div className="col-lg-6">
                            <div className="frelencer_content">
                                <Reveal effect="fadeInUp" duration={500}>
                                    <h2 className="t_color">Hey there!<br/> I'm Enzo Barrera <br/> Web  <span>Developer</span></h2>
                                </Reveal>
                                <Reveal effect="fadeInUp" duration={700}>
                                    <h4><span>I develop awesome experiences</span></h4>
                                </Reveal>
                                <Reveal effect="fadeInUp" duration={900}>
                                    <Link to="service" spy={true} smooth={true} offset={-86} duration={500} className="theme_btn active">See what I do</Link>
