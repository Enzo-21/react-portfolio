                    ...
                    <div className={`row align-items-center ${rowFlex}`}>
                        <div className="col-lg-5">
                            <div className="service_content">
                                ...
                                <p>I’m Enzo, a <span>professional web & apps developer</span> based in Argentina. I specialize in helping others grow their businesses 📈 or show their talents 😄.</p>
